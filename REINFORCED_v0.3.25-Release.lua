...
local MissionState = {
    ...
    zones = {
        ...
        ammoSupplyZone = nil  -- Ammo supply zone for supply cargo spawning
    },
    ...
    -- Supply Cargo Units - Management to be implemented
    availableSupplyCargoUnits = {
...
function Utils.discoverSupplyZones()
    ...
    return #truckZones > 0 or #heloZones > 0
end
